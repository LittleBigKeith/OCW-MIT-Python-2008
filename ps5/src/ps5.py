...
def play_hand(hand, word_list):
    ...
    * The final score is displayed.
      ...
      word_list: list of lowercase strings
    """
    starting_length = sum(hand.values())
    total_score = 0
    while True:
        # * The sum of the word scores is displayed when the hand finishes.
        if len(hand) == 0:
        ...
        # * An invalid word is rejected, and a message is displayed asking
        #   the user to choose another word.
        if not is_valid_word(current_word, hand, word_list):
        ...
        #   score so far are displayed, the remaining letters in the hand 
        #   are displayed, and the user is asked to input another word.
        word_score = get_word_score(current_word, starting_length)
        total_score += word_score
        print(f"{current_word} earned {word_score} points. Total: {total_score} points")
